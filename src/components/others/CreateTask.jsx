...
const CreateTask = () => {
  ...
  return (
    <div className='p-5 bg-[#1c1c1c] mt-7 rounded'>
         <form onSubmit ={(e)=>{
            submitHandler(e)
         }}className='flex flex flex-wrap w-full items-start justify-between'>
             <div className='w-1/2'>
             <div>
            ...
            <div className='w-2/5 flex flex-col items-start '>
                ...
                className=' w-full h-44 text-sm py-2 px-3 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4' name= "" id ="" cols="30" rows="10"></textarea>
